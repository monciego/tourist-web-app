                ...
                <div class="relative bg-white shadow-xl">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3">
                        ...
                        <div class="relative overflow-hidden py-10 px-6 bg-indigo-700 sm:px-10 xl:p-12">
                            ...
                            <dl class="mt-8 space-y-6">
                                ...
                                <dd class="flex text-base text-indigo-50">
                                    ...
                                    <svg class="flex-shrink-0 w-6 h-6 text-indigo-200"
                                    ...
                                    <div class="ml-3">
                                        <a class="underline block" href="tel:(075) 636 9558">(075) 636
                                            9558</a>
                                        <a class="underline " href="tel:(075) 636 9558">(075) 636
                                            9558</a>
                            ...
                            <ul role="list" class="mt-8 flex space-x-12">
                                <li>
                                    <a class="text-indigo-200 hover:text-indigo-100"
                                        href="https://www.facebook.com/dasolpangasinan.gov.ph1" target="__blank">
                        ...
                        <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                            ...
                            <form action="https://formspree.io/f/xyyaqzbr" method="POST"
