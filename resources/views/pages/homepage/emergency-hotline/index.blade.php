        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:text-center">
                ...
                <p class="mt-6 text-lg font-bold leading-8 text-gray-600">
                    Philippine National Hotline: <span class="text-red-600">
                        911
                    </span>
                </p>
            </div>
            <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-16 lg:max-w-4xl">
                <dl class="grid max-w-xl grid-cols-1 gap-y-6 gap-x-8 lg:max-w-none lg:grid-cols-2 lg:gap-y-10">
                    <div class="relative pl-16">
                        ...
                        <dd class="mt-2 text-base leading-7 text-gray-600">441414.</dd>
                    </div>
                    ...
                    <div class="relative pl-16">
                        ...
                        <dd class="mt-2 text-base leading-7 text-gray-600">1241412</dd>
                    </div>
                    ...
                    <div class="relative pl-16">
                        ...
                        <dd class="mt-2 text-base leading-7 text-gray-600">12412412</dd>
                    </div>
                    ...
                    <div class="relative pl-16">
                        ...
                        <dd class="mt-2 text-base leading-7 text-gray-600">124141</dd>
                    </div>
                </dl>
            </div>
        </div>
