        ...
        <form class="p-4" action="{{ route('store.homepage_tagline') }}" method="POST">
            ...
            <div>
                ...
                <x-input id="homepage_tagline" class="block mt-1 w-full" type="text" name="homepage_tagline" required
                    autofocus />
                @else
                <x-input id="homepage_tagline" class="block mt-1 w-full"
                    :value="old('homepage_tagline', $homepage_data->homepage_tagline)" type="text"
                    name="homepage_tagline" required autofocus />
                @endif
                @endforeach
