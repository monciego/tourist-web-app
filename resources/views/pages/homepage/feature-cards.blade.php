<div class="flex items-center justify-center px-6 lg:px-8">
    <div class="pb-5 pt-5 grid grid-cols-12 gap-3 w-full">
        ...
        <a href=""
            ...
            <img alt="{{ $property->property_name }}" src="{{ Storage::url($property->properties_details->image_one) }}"
            ...
            <div class="p-2">
                ...
                <p class="my-2 text-md md:text-xl font-bold">₱{{ $property->properties_details->property_price }}</p>
                @else
