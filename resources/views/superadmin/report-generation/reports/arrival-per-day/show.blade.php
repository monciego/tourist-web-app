<x-app-sidebar-layout>
    ...
    <header class="flex items-center mb-4 justify-between">
        <h2 class="text-md font-medium">Arrival Per Day</h2>
    ...
    {{-- Table --}}
    @unless ($arrivals_per_day->isEmpty())
    <div class="overflow-x-auto">
        <table class="table-auto w-full">
            ...
            <tbody class="text-sm font-medium divide-y divide-slate-100">
                {{-- row --}}
                @foreach ($arrivals_per_day as $arrival_per_day)

                <?php
                    $total_of_tourist = $arrival_per_day->total_number_of_adults + $arrival_per_day->total_number_of_children + $arrival_per_day->total_number_of_infants +$arrival_per_day->total_number_of_foreigner;
            $date = $arrival_per_day->day;
                ?>
                <tr>
                    <td class="p-2">
