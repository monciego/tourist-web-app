<x-app-sidebar-layout>
    ...
    <header class="flex items-center mb-4 justify-between">
        <h2 class="text-md font-medium">Night Tourist Arrival</h2>
        <a href="{{ route('export.night-tourists') }}"
    ...
    <div class="my-4 p-6 bg-white rounded">
        <h1 class="text-5xl text-center">{{ $night_tourists }}</h1>
    </div>
