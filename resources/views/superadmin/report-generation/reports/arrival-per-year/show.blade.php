<x-app-sidebar-layout>
    ...
    <header class="flex items-center mb-4 justify-between">
        <h2 class="text-md font-medium">Arrival Per Year</h2>
        <div class="flex items-center gap-2">
            <a href="{{ route('export.arrival-per-year') }}"
                    ...
                    <div>
                        ...
                        <div class="relative inline-block text-left">
                            ...
                            <div x-show="open" x-cloak
                                ...
                                @foreach ($arrivals_per_year as $arrival_per_year)
                                <a class="text-gray-700 block px-4 py-3 text-sm hover:bg-slate-100"
                                    href="{{ route('export.per.specific.year', $arrival_per_year->year) }}">
                                    Export {{ $arrival_per_year->year }}
                                </a>
                                @endforeach
                            </div>
                        </div>
    ...
    {{-- Table --}}
    @unless ($arrivals_per_year->isEmpty())
    <div class="overflow-x-auto">
        <table class="table-auto w-full">
            ...
            <tbody class="text-sm font-medium divide-y divide-slate-100">
                ...
                <?php
                    $total_of_tourist = $arrival_per_year->total_number_of_adults + $arrival_per_year->total_number_of_children + $arrival_per_year->total_number_of_infants +$arrival_per_year->total_number_of_foreigner;
            $date = $arrival_per_year->year;
                ?>
                <tr>
                    <td class="p-2">
