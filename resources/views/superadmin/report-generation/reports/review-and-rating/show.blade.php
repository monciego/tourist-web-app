<x-app-sidebar-layout>
    ...
    <header class="flex items-center mb-4 justify-between">
        ...
        <a href="{{ route('export.review.and.rating') }}"
    ...
    <div class="overflow-x-auto">
        <table class="table-auto w-full">
            ...
            <thead class="text-xs uppercase text-slate-400 bg-slate-50 rounded-sm">
                <tr>
                    <th class="p-2">
                        <div class="font-semibold text-left">Property Name</div>
                    </th>
                    <th class="p-2">
                        <div class="font-semibold text-left">Number of Reviews</div>
                    </th>
                </tr>
            </thead>
            {{-- table body --}}
            <tbody class="text-sm font-medium divide-y divide-slate-100">
                ...
                <tr class="{{ $loop->first ?  'bg-indigo-700 text-white' : 'bg-none text-slate-800'}}">
                    <td class="p-2">
                    ...
                    <td class="p-2 flex items-center justify-between">
                        ...
                        @if ($loop->first)
                        <div class="text-white  bg-green-700 px-4 py-1 rounded">
                            Most Reviewed Place
                        </div>
                        @endif
                    </td>
    ...
    <div class="flex-col flex items-center justify-center">
        ...
        <div>
            <h1 class="text-center font-bold text-xl mt-8 uppercase">
                There are currently no reviewed places
            </h1>
        </div>
    </div>
    @endunless
