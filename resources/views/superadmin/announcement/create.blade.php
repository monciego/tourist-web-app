<div x-data="{open:false}" class="inline">
    <button x-on:click="open = true"
        ...
        <span class="xs:block text-sm ml-2">Create Announcement</span>
    </button>
    ...
    <div x-show="open" x-cloak>
        <div class="absolute bg-slate-50 shadow-md rounded-md top-2/4 left-2/4 w-3/4 -translate-y-2/4 -translate-x-2/4"
            ...
            <header class="flex justify-between items-center  p-4 border rounded-md border-b-1 border-gray-200">
                <h2 class="font-medium">Add Announcement</h2>
            ...
            <form class="p-4" action="{{ route('announcements.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div>
                ...
                <div class="mt-4">
                    ...
                    <input class="mt-1 w-full" id="article_image" name="article_image" type="file" required>
                </div>
