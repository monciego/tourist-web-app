<div x-data="{open:false}" class="inline">
    <button x-on:click="open = true"
        ...
        <span class="xs:block text-sm ml-2">Add Description for {{ $properties->property_name }}</span>
    </button>
    ...
    <div x-show="open" x-cloak>
        <div class="absolute bg-slate-50 shadow-md rounded-md top-2/4 left-2/4 w-full -translate-y-2/4 -translate-x-2/4"
            ...
            <header class="flex justify-between items-center  p-4 border rounded-md border-b-1 border-gray-200">
                <h2 class="font-medium">Add Description</h2>
            ...
            <form class="p-4" action={{ route('store-description') }} method="POST">
                @csrf
