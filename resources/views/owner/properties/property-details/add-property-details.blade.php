<div x-data="{open:false}" class="inline">
    ...
    <div x-show="open" x-cloak>
        <div class="absolute bg-slate-50 shadow-md rounded-md top-2/4 left-2/4 w-full -translate-y-2/4 -translate-x-2/4"
            style="z-index: 501;">

            <header class="flex justify-between items-center  p-4 border rounded-md border-b-1 border-gray-200">
                <h2 class="font-medium">Add Details</h2>
            ...
            <form class="p-4" action="{{ route('store-property-details') }}" method="POST">
                @csrf
                {{-- property_details --}}
                ...
                <div>
                    ...
                    <textarea name="property_details" id="property_details" autocomplete="property_details"
                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('property_details') }}</textarea>
                </div>
