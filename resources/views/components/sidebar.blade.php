...
<nav class="space-y-8">
    ...
    <div>
        ...
        <ul class="mt-3">
            ...
            {{-- report generation --}}
            <x-sidebar-nav-link class="mt-2" :href="route('report-generation.index')"
            ...
            {{-- review and rating --}}
            <x-sidebar-nav-link class="mt-2" :href="route('review-and-rating.index')"
            ...
            <x-sidebar-nav-link class="mt-2" :href="route('change-password.index')"
